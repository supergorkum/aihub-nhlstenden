...
export const INIT_LINKJES = [
  { id: 1, titel: 'Intranet NHL Stenden', url: 'https://nhlstenden.sharepoint.com', omschrijving: 'Het centrale intranet voor medewerkers.', intern: true, intern: true, intern: true, categorie: 'intranet', spoor: null, laag: null, trefwoorden: ['Intranet', 'Medewerkers'], toegevoegdDoor: 'Kernteam AI-HUB', datum: 'Juni 2026' },
...
export const INIT_INSPIRATIES = [
  ...
  { id: 4, type: 'artikel', icon: '📰', typelabel: 'Artikel of publicatie', rol: 'Medewerker dienst', naam: 'CTL NHL Stenden', intern: true, spoor: 3, sporeDef: { titel: 'AI & Verantwoordelijkheid', icon: '⚖️' }, laag: 4, titel: 'NHL Stenden kiest geen AI-detector voor toetsing', tekst: 'NHL Stenden heeft bewust gekozen geen AI-detector aan te schaffen. Detectoren zijn niet betrouwbaar en effectieve detectie wordt steeds lastiger. Het beleid focust op sterk toetsontwerp en heldere toetsinstructie.', url: 'https://newuniversity.sharepoint.com/sites/center-for-teaching-and-learning/SitePages/AI---toetsing,-richtlijnen-en-beoordeling.aspx', datum: '25 juni 2026', trefwoorden: ['Toetsing', 'Beleid', 'GenAI', 'CTL'], stemmen: { omhoog: 0, omlaag: 0 } },
  { id: 5, type: 'ontwikkeling', icon: '🌐', typelabel: 'Interessante ontwikkeling', rol: 'Medewerker dienst', naam: 'CTL NHL Stenden', intern: true, spoor: 1, sporeDef: { titel: 'AI & Leren', icon: '🎓' }, laag: 5, titel: 'UvA lanceert eigen AI-chat voor veilig experimenteren', tekst: 'De Universiteit van Amsterdam lanceerde een eigen AI-chatomgeving voor veilig experimenteren. Relevant als referentie voor NHL Stenden GPT-NL inzet.', url: 'https://newuniversity.sharepoint.com/sites/center-for-teaching-and-learning/SitePages/UvA-lanceert-eigen-AI-chat--veilig-exp-.aspx', datum: '25 juni 2026', trefwoorden: ['AI-chat', 'Veiligheid', 'Soevereiniteit', 'UvA'], stemmen: { omhoog: 0, omlaag: 0 } },
  { id: 6, type: 'artikel', icon: '📰', typelabel: 'Artikel of publicatie', rol: 'Docent', naam: 'Patrick van Aalst', intern: true, spoor: 1, sporeDef: { titel: 'AI & Leren', icon: '🎓' }, laag: 5, titel: 'AI & the stability of learning tasks', tekst: 'CTL-artikel over de impact van AI op de stabiliteit van leeractiviteiten. Vraagt docenten kritisch te kijken welke toetsvormen nog valide zijn in een GenAI-tijdperk.', url: 'https://newuniversity.sharepoint.com/sites/center-for-teaching-and-learning/SitePages/AI-&-the-stability-of-learning-tasks.aspx', datum: '25 juni 2026', trefwoorden: ['Didactiek', 'Toetsing', 'Leeractiviteiten', 'GenAI'], stemmen: { omhoog: 0, omlaag: 0 } },
]
