...
const INIT_BRONNEN = [
  ...
  { id: 7, doelgroep: 'medewerkers', type: 'cursus', titel: 'AI op je werkplek: Basis & Prompten en toepassen', url: 'https://newuniversity.sharepoint.com/sites/MyAcademy', omschrijving: 'Twee workshops van 90 minuten via MyAcademy: \'AI op je werkplek - Basis\' en \'AI op je werkplek - Prompten en toepassen\'. Onderdeel van het thema Digitale tools in het MyAcademy-aanbod voor medewerkers.', stemmen: 0, toegevoegdDoor: 'MyAcademy', datum: '30 juni 2026' },
]
