...
export const THEMAS = [
  {
    ...
    toelichting:
      'AI verandert hoe studenten leren en hoe docenten begeleiden. Van adaptieve feedback tot slimmere toetsing en vroegtijdig signaleren van uitval: dit thema gaat over AI als versterker van het onderwijs, niet als vervanging van de docent. NHL Stenden wil dat AI bijdraagt aan studiesucces voor elke student, ongeacht achtergrond of leerstijl.',
    watValtHieronder:
      'Didactische vernieuwing, AI in toetsing en integriteit, curriculumontwikkeling, studieloopbaanbegeleiding en de inzet van AI om uitval vroegtijdig te signaleren en te voorkomen.',
    slug: 'leren',
  },
  {
    id: 'werken',
