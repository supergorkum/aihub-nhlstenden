...
export const INIT_PILOTS = [
  ...
  },
  {
    ...
    status: 'In ontwikkeling',
    doel: 'De AMCE wil als proeftuin voor de hogeschool ervaring opdoen met verantwoorde AI-oplossingen voor onderwijsontwikkeling, professionalisering en praktijkgerichte leeromgevingen. De pilot omvat vier werkpakketten: data- en workflow-AI, RAG-agents, visuele prototyping en evaluatie van agentic workflows.',
    bereiken: 'Veilige experimenteerruimte, AI-geletterdheid docenten en studenten, concrete prototypes voor curricula, inzicht in kosten en opschaalbaarheid, minder afhankelijkheid van losse persoonlijke AI-accounts.',
    spoor: 1, laag: 5,
  ...
  },
  {
    ...
    status: 'In ontwikkeling',
    doel: 'Verkennen hoe AI verschillende databronnen (GA4, SEO, CRM, APIs) op een gecontroleerde manier kan verbinden. Studenten leren data-informed werken en kritisch kijken naar datakwaliteit en bias.',
    bereiken: 'Werkend prototype voor een onderwijssetting waarin studenten meerdere databronnen bevragen en analyseren met AI-ondersteuning.',
    spoor: 2, laag: 4,
    surf: 'Nee / niet van toepassing',
  ...
  },
  {
    ...
    status: 'In ontwikkeling',
    doel: 'Ontwikkelen van RAG-gestuurde AI-agents gevoed met gevalideerde academiedocumenten (OER, rubrics, beroepsprofielen). De agent ondersteunt docenten, studenten en onderwijsontwikkelaars bij uitleg, oriëntatie en kennisontsluiting.',
    bereiken: 'Twee of drie geteste AI-agents inclusief bronbeheer, gebruiksinstructie en evaluatie op betrouwbaarheid.',
    spoor: 1, laag: 4,
    surf: 'Nee / niet van toepassing',
  ...
  },
  {
    ...
    status: 'In ontwikkeling',
    doel: 'Verkennen hoe beeldgeneratie kan bijdragen aan sneller ontwerpen, testen en presenteren van ideeën. Studenten leren AI-beeld beoordelen op kwaliteit, inclusie, stereotypering en ethiek.',
    bereiken: 'Didactisch format voor verantwoord gebruik van image generation in ontwerpgerichte onderwijsactiviteiten.',
    spoor: 1, laag: 3,
    surf: 'Nee / niet van toepassing',
  ...
  },
  {
    ...
    status: 'In ontwikkeling',
    doel: 'Onderzoeken welke typen AI-werkprocessen het best passen bij Claude danwel Copilot voor complexere agentic workflows: redeneren, documentanalyse, taakopdeling en iteratief samenwerken.',
    bereiken: 'Evaluatie van bruikbaarheid, veiligheid, kosten, outputkwaliteit en didactische toepasbaarheid van agentic workflows.',
    spoor: 2, laag: 4,
    surf: 'Nee / niet van toepassing',
...
export const INIT_INSPIRATIES = [
  {
    id: 1001,
    titel: 'Human Value AI — de professional als regisseur',
    omschrijving: 'De meerwaarde van studenten ligt niet in concurreren met AI, maar in het kunnen sturen, beoordelen, contextualiseren en verantwoord toepassen ervan. De professional van de toekomst gebruikt AI om betere vragen te stellen, sneller scenario\'s te ontwikkelen en waarde te creren voor mens, organisatie en samenleving.',
    bron: 'AMCE NHL Stenden — AI-pilot voorstel 2026',
    bronUrl: '',
    categorie: 'visie',
    spoor: 4,
    bronLabel: 'NHL Stenden intern',
    intern: true,
    trefwoorden: ['Human Value AI', 'Professionalisering', 'Regie', 'Toekomst'],
  },
