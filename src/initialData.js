...
export const INIT_DOCS = [
  ...
  { id: 2, titel: 'AI-HUB Fundament v1.2', categorie: 'strategie', spoor: null, type: 'pdf', datum: 'Juni 2026', omschrijving: 'Fundament document met opzet, themas en netwerkorganisatie.', icon: '📄' },
